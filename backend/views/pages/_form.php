...
$('input#pages-title').keyup(function(){
    ...
    $('input#pages-url').val(NewText);    
});
$('input#pages-title_ru').keyup(function(){
        var Text = $(this).val();
        NewText = makeSlug(Text);
    $('input#pages-url_ru').val(NewText);    
});
$('input#pages-title_en').keyup(function(){
        var Text = $(this).val();
        NewText = makeSlug(Text);
    $('input#pages-url_en').val(NewText);    
})
JS
    , 3)
?>
