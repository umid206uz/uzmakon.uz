...
<div class="setting-form">
    ...
    <div class="row">
        ...
        <?= $form->field($model, 'admin_bot_token')->textInput(['maxlength' => true]) ?>

        <?= $form->field($model, 'orders_bot_token')->textInput(['maxlength' => true]) ?>

        <?= $form->field($model, 'post_bot_token')->textInput(['maxlength' => true]) ?>

        <?= $form->field($model, 'get_order_bot_token')->textInput(['maxlength' => true]) ?>

        <?= $form->field($model, 'admin_group_link')->textInput(['maxlength' => true]) ?>
