 ...
 */
class OperatorOrdersSearch extends OperatorOrders
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'order_id', 'operator_id', 'amount', 'status'], 'integer'],
    ...
    {
        $query = OperatorOrders::find()->where(['operator_id' => $admin_id])->orderBy(['id' => SORT_DESC]);
