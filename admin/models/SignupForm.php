...
class SignupForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            ['username', 'unique', 'targetClass' => '\admin\models\User', 'message' => Yii::t("app", "This username has already been taken.")],
            ['username', 'string', 'min' => 2, 'max' => 255],
            ['rememberMe', 'boolean'],
            ['email', 'trim'],
            ['email', 'email', 'message' => Yii::t("app","This email is not valid")],
            ['email', 'string', 'max' => 255],
            ['email', 'unique', 'targetClass' => '\admin\models\User', 'message' => Yii::t("app", "This email address has already been taken.")],
