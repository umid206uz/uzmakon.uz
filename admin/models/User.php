...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            [['first_name' , 'last_name', 'tell', 'occupation', 'url', 'card', 'filename', 'code'], 'string', 'max' => 255],
            ['access_token', 'string', 'max' => 100],
            [['operator_price', 'step', 'status_new', 'status_being_delivered', 'status_delivered', 'status_returned', 'status_black_list', 'status_then_takes', 'status_ready_to_delivery', 'status_hold', 'status_preparing'], 'integer'],
     ...
     * @return bool if verification code provided is valid for current user
     */
    public function validateVerificationCode($code): bool
    {
    ...
    /**
     * Generates verification code hash from verification code and sets it to the model
     *
     * @param string $code
     */
