                    ...
                    <div class="card mb-4 shadow-sm border-0">
                        <div class="card-body text-left">
                            ...
                            <ul class="nav nav-pills nav-fill flex-column sidemenu">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-left active" href="<?= Url::to(['/site/change-password'])?>"><?=Yii::t("app", "Change password")?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-left" href="<?= Url::to(['/site/change-picture'])?>"><?=Yii::t("app", "Change picture")?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
