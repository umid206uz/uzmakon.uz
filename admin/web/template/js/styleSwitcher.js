...
(function($) {
    ...
    versionSelect.on('change', function() {
		...
		if(this.value === 'light'){
			jQuery(".nav-header .logo-abbr").attr("src", "/frontend/web/dashboard/images/logo-abbr.png");
			jQuery(".nav-header .logo-compact").attr("src", "/frontend/web/dashboard/images/brand-title.png");
			jQuery(".nav-header .brand-title").attr("src", "/frontend/web/dashboard/images/brand-title.png");
			
			setCookie('logo_src', '/frontend/web/dashboard/images/logo-abbr.png');
			setCookie('logo_src2', '/frontend/web/dashboard/images/brand-title.png');
		}else{
