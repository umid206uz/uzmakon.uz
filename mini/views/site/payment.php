...
/* @var $model mini\models\OperatorPayment */
/* @var $searchModel mini\models\OperatorPaymentSearch */
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <?= $form->field($model, 'operator_id')->textInput(['placeholder' => Yii::t("app","Credit card number"), 'value' => Yii::$app->formatter->currentUser()->card, 'disabled' => true])->label(false)?>
                        </div>
                        <div class="col-md-5">
                            <?= $form->field($model, 'amount')->textInput(['placeholder' => Yii::t("app","Please enter the amount")])->label(false)?>
                        </div>
                        <div class="col-md-2">
