...
/* @var $balance_debt int */
/* @var $balance_right int */
                    ...
                    <div class="portlet light profile-sidebar-portlet ">
                        ...
                        <div class="profile-usermenu">
                            <ul class="nav">
                                <li>
                                    <a href="/">
                                        <i class="icon-home"></i> <?=Yii::t("app", "Home")?>
                                    </a>
                                </li>
                                <li class="active">
                                    <a href="#">
                                        <i class="icon-settings"></i> <?=Yii::t("app", "Balance")?> - <?=Yii::$app->formatter->getPrice($balance_right - $balance_debt)?></a>
                                </li>
                            </ul>
                        </div>
                        <!-- END MENU -->
