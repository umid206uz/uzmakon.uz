    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="client-card" style="padding: 15px; border-left: 4px solid #764ba2; margin-bottom: 15px; background-color: white; border-radius: 8px;">
                ...
                <p><strong><?=Yii::t("app","Additional phone number")?>:</strong> <a href="tel:<?=$model->additional_phone?>" id="customer_phone"><?=Yii::$app->formatter->asPhone($model->additional_phone)?></a></p>
            </div>
            ...
            <div class="additional-info-card" style="padding: 15px; border-left: 4px solid #36c5b9; background-color: white; border-radius: 8px;">
                ...
                <p><strong><?=Yii::t("app","The last practice")?>:</strong> <span id="additional_info"><?=Yii::$app->formatter->getDate($model->updated_date)?></span></p>
                <p><strong><?=Yii::t("app","Take time")?>:</strong> <span id="additional_phone"><?=Yii::$app->formatter->getDate($model->take_time)?></span></p>
                <p><strong><?=Yii::t("app","Additional Information")?>:</strong> <span id="additional_address"><?=$model->comment?></span></p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="product-card" style="display: flex; flex-direction: column; align-items: center; padding: 20px; background-color: white; margin-bottom: 15px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
                ...
                <div class="product-image" style="width: 100%; height: 250px; overflow: hidden; border-radius: 12px; margin-bottom: 15px;">
                    <img src="https://olchamarket.uz/backend/web/uploads/product/<?=$model->product->photo->filename?>" alt="Product Image" style="width: 100%; height: 100%; object-fit: cover;">
                </div>
