...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="/">
                <img src="https://<?=Yii::$app->params['og_url_name']['content']?>/backend/web/uploads/<?=$setting->logo_bottom?>" alt="logo" class="logo-default" /> </a>
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                ...
                <li class="sidebar-search-wrapper">
                    ...
                    <form class="sidebar-search" action="<?= Url::to(['site/search'])?>" method="GET">
                ...
                <li class="nav-item <?=(Yii::$app->controller->action->id == "order-complete") ? "start active open" : ""?>">
                    <a href="<?= Url::to(['site/order-complete'])?>" class="nav-link nav-toggle">
                ...
                <li class="nav-item <?=(Yii::$app->controller->action->id == "ordering") ? "start active open" : ""?>">
                    <a href="<?= Url::to(['site/ordering'])?>" class="nav-link nav-toggle">
                        <i class="fa fa-car"></i>
                ...
                <li class="nav-item <?=(Yii::$app->controller->action->id == "ordered") ? "start active open" : ""?>">
                    <a href="<?= Url::to(['site/ordered'])?>" class="nav-link nav-toggle">
                ...
                <li class="nav-item <?=(Yii::$app->controller->action->id == "waiting") ? "start active open" : ""?>">
                    <a href="<?= Url::to(['site/waiting'])?>" class="nav-link nav-toggle">
                ...
                <li class="nav-item <?=(Yii::$app->controller->action->id == "hold") ? "start active open" : ""?>">
                    <a href="<?= Url::to(['site/hold'])?>" class="nav-link nav-toggle">
                ...
                <li class="nav-item <?=(Yii::$app->controller->action->id == "feedback") ? "start active open" : ""?>">
                    <a href="<?= Url::to(['site/feedback'])?>" class="nav-link nav-toggle">
                ...
                <li class="nav-item <?=(Yii::$app->controller->action->id == "come-back") ? "start active open" : ""?>">
                    <a href="<?= Url::to(['site/come-back'])?>" class="nav-link nav-toggle">
                ...
                <li class="nav-item <?=(Yii::$app->controller->action->id == "returned") ? "start active open" : ""?>">
                    <a href="<?= Url::to(['site/returned'])?>" class="nav-link nav-toggle">
                ...
                <li class="nav-item <?=(Yii::$app->controller->action->id == "black-list") ? "start active open" : ""?>">
                    <a href="<?= Url::to(['site/black-list'])?>" class="nav-link nav-toggle">
                ...
                <li class="nav-item <?=(Yii::$app->controller->action->id == "order-history") ? "start active open" : ""?>">
                    <a href="<?= Url::to(['site/order-history'])?>" class="nav-link nav-toggle">
                        <i class="fa fa-money"></i>
                        <span class="title"><?=Yii::t("app", "Order history")?></span>
                        <span class="selected"></span>
                    </a>
                </li>
                <li class="nav-item">
...
<div class="page-footer">
    <div class="page-footer-inner"> <?=date('Y')?> &copy; <?=Yii::$app->params['og_site_name']['content']?>.
        <a href="http://t.me/umid206" title="Purchase Metronic just for 27$ and get lifetime updates for free" target="_blank">Created By umid206!</a>
    </div>
